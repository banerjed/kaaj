...
INSERT INTO ticketing_business_areas (id, tenant_id, prefix, name, description, current_sequence, is_active, created_at, created_by, updated_at) VALUES
    ('872ea5b0-1dc9-5e20-be3e-5eaa8c431c0c', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'IT', 'IT Support', 'Internal IT and equipment requests', 3, TRUE, '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85', '2026-01-01T09:00:00Z'),
    ('2e90b722-25ef-51b7-866b-e93d3bcca1c3', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'FAC', 'Facilities', 'Office and facilities requests', 1, TRUE, '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85', '2026-01-01T09:00:00Z'),
    ('c9800088-b86b-5ddd-acdc-5b9fbe32f268', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'CS', 'Client Support', 'Client-raised support tickets', 2, TRUE, '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85', '2026-01-01T09:00:00Z');

UPDATE ticketing_business_areas SET
    roles = '{"agent": ["update", "assign"], "manager": ["close", "reopen"]}'::jsonb
WHERE tenant_id = '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1';

-- Client Support is the one business area a portal contact may submit into
-- (docs/17-customer-portal.md §2) — IT and Facilities stay internal-only.
UPDATE ticketing_business_areas SET
...
INSERT INTO ticketing_updates (id, tenant_id, ticket_id, ticket_number, update_type, author_employee_id, author_name, content_text, visibility, created_at) VALUES
    ('9b9048a4-633b-542c-aa10-5e701d68d599', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'a22f6d41-d654-5951-a043-e174f7e1a258', 'IT-0001', 'comment', 'a87e0200-0849-53b6-a491-e882feace3f5', 'E010', 'Replacement unit ordered, ETA Thursday.', 'internal', '2026-01-01T09:00:00Z'),
    ('adeb5b8f-2931-5953-8f88-20f70c485ca5', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'a22f6d41-d654-5951-a043-e174f7e1a258', 'IT-0001', 'comment', 'b9b84064-a67a-5048-8282-8fc048b4dbfb', 'E004', 'Thanks - I can work from the spare machine until then.', 'internal', '2026-01-01T09:00:00Z'),
    ('04634de5-de4e-51a9-91b1-4e08eed80953', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', '81535673-0241-5ed1-bb17-6fe1c042e9f1', 'IT-0002', 'comment', 'a87e0200-0849-53b6-a491-e882feace3f5', 'E010', 'VPN profile issued and tested.', 'internal', '2026-01-01T09:00:00Z'),
    ('d746ac08-167a-52b6-9e0d-14717998905e', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', 'db1f1f2b-b140-5948-a34e-1c998ed98757', 'E002', 'Traced to a missing index on the reporting query.', 'internal', '2026-01-01T09:00:00Z'),
    ('eccad372-c665-5b56-845a-4880f7df21a2', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', '11f31511-ad53-59c7-9e90-8ee3b553489b', 'E005', 'Client confirmed the slowdown started last Tuesday.', 'internal', '2026-01-01T09:00:00Z'),
    ('a33c3c9c-0762-5919-82da-ce25bad737bf', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', '6e78ba43-d504-546e-933d-4a5dce8d3313', 'CS-0002', 'comment', 'b9b84064-a67a-5048-8282-8fc048b4dbfb', 'E004', 'Sent the CSV schema documentation.', 'internal', '2026-01-01T09:00:00Z'),
    ('f18f5a9e-0f9e-5f3d-9c3a-2f6f6a2b9e11', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', '11f31511-ad53-59c7-9e90-8ee3b553489b', 'E005', 'We''ve identified a missing index and are deploying a fix — no action needed on your end.', 'external', '2026-01-02T10:00:00Z');
...
INSERT INTO ticketing_updates (id, tenant_id, ticket_id, ticket_number, update_type, author_employee_id, author_name, content_text, visibility, created_at) VALUES
    ('1a2b3c4d-0001-5000-8000-000000000001', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', '81535673-0241-5ed1-bb17-6fe1c042e9f1', 'IT-0002', 'comment', 'b9b84064-a67a-5048-8282-8fc048b4dbfb', 'E004', 'Confirmed VPN connects from home network.', 'external', '2026-01-01T11:00:00Z'),
    ('1a2b3c4d-0001-5000-8000-000000000002', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', '81535673-0241-5ed1-bb17-6fe1c042e9f1', 'IT-0002', 'comment', 'a87e0200-0849-53b6-a491-e882feace3f5', 'E010', 'Closing this out — access confirmed working.', 'internal', '2026-01-01T12:00:00Z'),
    ('1a2b3c4d-0001-5000-8000-000000000003', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', '81535673-0241-5ed1-bb17-6fe1c042e9f1', 'IT-0002', 'comment', 'b9b84064-a67a-5048-8282-8fc048b4dbfb', 'E004', 'Thank you!', 'external', '2026-01-01T12:30:00Z'),
    ('1a2b3c4d-0002-5000-8000-000000000001', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', 'db1f1f2b-b140-5948-a34e-1c998ed98757', 'E002', 'Index build running against the replica first.', 'internal', '2026-01-03T09:00:00Z'),
    ('1a2b3c4d-0002-5000-8000-000000000002', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', 'db1f1f2b-b140-5948-a34e-1c998ed98757', 'E002', 'Replica build finished clean, no lock contention observed.', 'internal', '2026-01-04T09:00:00Z'),
    ('1a2b3c4d-0002-5000-8000-000000000003', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', '11f31511-ad53-59c7-9e90-8ee3b553489b', 'E005', 'Scheduling the production deploy for tonight''s maintenance window.', 'external', '2026-01-05T09:00:00Z'),
    ('1a2b3c4d-0002-5000-8000-000000000004', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', 'db1f1f2b-b140-5948-a34e-1c998ed98757', 'E002', 'Deployed to production, monitoring query times.', 'internal', '2026-01-06T09:00:00Z'),
    ('1a2b3c4d-0002-5000-8000-000000000005', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', 'db1f1f2b-b140-5948-a34e-1c998ed98757', 'E002', 'Report generation time down from 40s to 2s.', 'internal', '2026-01-06T15:00:00Z'),
    ('1a2b3c4d-0002-5000-8000-000000000006', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', '11f31511-ad53-59c7-9e90-8ee3b553489b', 'E005', 'Fix confirmed live — reports are fast again, thank you!', 'external', '2026-01-06T16:00:00Z'),
    ('1a2b3c4d-0002-5000-8000-000000000007', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'fbc213ca-f362-58d3-aa36-45db45958e60', 'CS-0001', 'comment', 'db1f1f2b-b140-5948-a34e-1c998ed98757', 'E002', 'Closing out — will keep an eye on query plans for a week regardless.', 'internal', '2026-01-07T09:00:00Z');
...
-- Two tickets already about a real customer by title, wired to the real
-- row now that customers exists (ticketing_tickets was seeded before this
-- point in the file — this must run after). CS-0003 is set in its own
-- INSERT below, once customer_contacts exists too.
UPDATE ticketing_tickets SET customer_id = 'e40d0f18-1333-5cd1-a969-f5113df51e70'
WHERE ticket_number = 'CS-0001';
UPDATE ticketing_tickets SET customer_id = 'ac7a04b4-a28e-5a15-9993-596db32c8d4e'
WHERE ticket_number = 'CS-0002';
...
UPDATE ticketing_tickets SET
    ...
    reported_by_email = 'dana.whitcombe@acme.example'
WHERE ticket_number = 'CS-0003';

-- CS-0003 was inserted with a literal sequence_number rather than through
-- nextTicketNumber(), so the counter it increments never moved past what
-- CS-0001/0002 left it at — the next portal submission would collide on
-- ticketing_tickets_tenant_id_ticket_number_key, generating CS-0003 again.
UPDATE ticketing_business_areas SET current_sequence = 3 WHERE prefix = 'CS';

-- Author is the portal contact herself.
INSERT INTO ticketing_updates (id, tenant_id, ticket_id, ticket_number, update_type, author_contact_id, author_name, content_text, visibility, created_at) VALUES
    ('c2e6a442-2b0c-5e63-9a8b-6b4a5b6f2d31', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', '16a68eb5-4d61-5548-8e17-8f1ac4c2f5c9', 'CS-0003', 'comment', 'da1d1f9e-9d10-4d13-a3d9-b90f49903a13', 'Dana Whitcombe', 'Just to clarify — this is about the invoice dated Feb 1, not the one from January.', 'external', '2026-03-03T14:05:00Z');
...
INSERT INTO ticketing_updates (id, tenant_id, ticket_id, ticket_number, update_type, author_employee_id, author_name, content_text, visibility, created_at)
SELECT gen_random_uuid(), '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', t.id, t.ticket_number, 'comment', 'a87e0200-0849-53b6-a491-e882feace3f5', 'E010', 'Progress update #' || gs || ': switch replacement continuing on schedule.', CASE WHEN gs % 7 = 0 THEN 'external' ELSE 'internal' END, ('2026-01-01T09:00:00Z'::timestamptz + (gs || ' hours')::interval)
...
-- Keyed on severity, not the (now-dropped) priority column — the fixture
-- always set them to the same value per row, so this changes nothing.
UPDATE ticketing_tickets SET
    sla_response_due_at = logged_at + (CASE severity WHEN 'high' THEN INTERVAL '4 hours'
                                                     WHEN 'medium' THEN INTERVAL '8 hours'
                                                     ELSE INTERVAL '24 hours' END),
    sla_due_at          = logged_at + (CASE severity WHEN 'high' THEN INTERVAL '24 hours'
                                                     WHEN 'medium' THEN INTERVAL '72 hours'
                                                     ELSE INTERVAL '120 hours' END),
    first_response_at   = logged_at + INTERVAL '90 minutes'
WHERE status <> 'open' OR severity = 'high';
...
-- employees.manager_id, not granted — Sarah (E001), Aisha (E005) and Diego
-- (E008) already have direct reports, so no separate "manager" grant exists
-- or is needed to reach that persona.
--
-- Every base role and every functional role in packages/authz has at least
-- one seeded login (dev-users.sql turns every row here into one), and three
-- people deliberately hold more than one hat — realistic for a firm this
-- size, and exactly the shape docs/14-access-control.md calls out ("small
-- firms wear several hats"):
--   E001 Sarah  — owner + payroll_admin, and a manager of three.
--   E006 James  — firm_admin + legal_admin + project_manager.
--   E008 Diego  — sales_admin + finance_admin, and a manager of one.
-- E007 (Lena) and E010 (Rachel) hold hr_admin/payroll_admin and auditor in
-- ISOLATION on purpose — a CHECK constraint refuses the same person holding
-- hr_admin with payroll_admin, or auditor with any other role, and mixing
-- either into a multi-hat example here would just be untestable SQL.
...
SELECT
    ...
    e.id,
    CASE e.employee_id
        WHEN 'E001' THEN 'owner'         -- everything, and the only biller
        WHEN 'E006' THEN 'firm_admin'    -- everything except billing/members/pii.erase
        WHEN 'E012' THEN 'contractor'    -- matches her employment_type
        ELSE 'employee'
    END,
    CASE e.employee_id
        WHEN 'E001' THEN ARRAY['payroll_admin']::text[]
        WHEN 'E006' THEN ARRAY['legal_admin', 'project_manager']::text[]
        WHEN 'E007' THEN ARRAY['auditor']::text[]              -- read-only, alone, by CHECK
        WHEN 'E008' THEN ARRAY['sales_admin', 'finance_admin']::text[]
        WHEN 'E009' THEN ARRAY['marketing_admin']::text[]
...
-- exercises "a manager's unfinished assessment is withheld".
...
-- Named by ticket_number, not `ORDER BY id LIMIT 2` (arbitrary UUID sort) —
-- that silently caught CS-0003 (the freshly-submitted, still-open portal
-- ticket added for the customer-portal demo) depending on how its UUID
-- happened to sort. IT-0002 and CS-0002 were both 'resolved' in their
