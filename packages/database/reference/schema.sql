...
CREATE TABLE employees (
    ...
    base_amount_pvt           NUMERIC(18,4),
    currency              TEXT DEFAULT 'USD',
    overtime_eligible     BOOLEAN DEFAULT FALSE,
    default_hourly_rate_pvt   NUMERIC(18,4),
    default_billable_rate_pvt NUMERIC(18,4),
    pto_balances          JSONB DEFAULT '{}'::jsonb,
    tax_withholding_pvt       JSONB DEFAULT '{}'::jsonb,
    salary_structure_pvt      JSONB DEFAULT '{}'::jsonb,
    variable_compensation_pvt JSONB DEFAULT '[]'::jsonb,
    benefits_elections_pvt    JSONB DEFAULT '{}'::jsonb,
