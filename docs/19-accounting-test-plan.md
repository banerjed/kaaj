...
- Write-off of bad debt moves the balance out of AR into an expense/allowance account and is auditable. **[MISSING]**
  *No write-off feature exists. The reversing-entry mechanism it needs now does (`invoice_credits`, shipped 2026-09-13 for credit memos) — the remaining blocker is that `chart_of_accounts` has no Bad Debt Expense account, a fixture change with its own snapshot consequences, deliberately scoped out of the credit-memo pass.*
