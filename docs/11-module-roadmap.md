...
**Status:** active
**Created:** 2026-08-29
**Last verified against the code:** 2026-09-04, at `6c07ed6`
...
Ticketing (4 tables) — ✅ built, both staff and portal side. Change requests
(deferred from Phase 2) and user groups remain, each depends on the employee
record being complete.

**Ticketing's biggest piece was a second class of authenticated actor, and
that piece is built.** [17-customer-portal.md](./17-customer-portal.md)
...
each inventing its own. Portal identity (§1) and ticketing (§2) are both
