...
18. **[api-surface.md](./api-surface.md)** - **Authoritative interface contract** (generated)
...
19. **[data-models/schema.sql](../packages/database/reference/schema.sql)** - **Authoritative database schema**
...
20. **[data-models/mock-data.sql](../packages/database/fixtures/mock-data.sql)** - Test organization
...
21. **[data-models/SCHEMA-RECONCILIATION.md](./data-models/SCHEMA-RECONCILIATION.md)** - Schema Reconciliation
