...
INSERT INTO employees (id, tenant_id, employee_id, employee_number, first_name, last_name, email, phone, employment_status, employment_type, start_date, department_code, job_title, job_level, location_code, manager_id, timezone, currency, base_amount, compensation_type, pay_frequency, overtime_eligible, default_billable_rate, fte, is_active, custom_fields, pto_balances, created_at, updated_at, created_by) VALUES
    ('6d466aa9-e51a-5d52-9015-152600855932', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E001', 'E001', 'Sarah', 'Johnson', 'sarah.johnson@northwind.example', '+1-212-555-0001', 'active', 'full_time', '2024-11-27', 'ENG', 'Engineering Manager', 'L4', 'US-NYC', NULL, 'America/New_York', 'USD', 185000, 'salary', 'monthly', FALSE, 225, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E001"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('db1f1f2b-b140-5948-a34e-1c998ed98757', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E002', 'E002', 'Marcus', 'Chen', 'marcus.chen@northwind.example', '+1-212-555-0002', 'active', 'full_time', '2024-12-17', 'ENG-BE', 'Software Engineer', 'L4', 'IN-BLR', '6d466aa9-e51a-5d52-9015-152600855932', 'Asia/Kolkata', 'INR', 3200000, 'salary', 'monthly', TRUE, 95, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E002"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('bf17b1af-963b-53ef-9083-21506fb34e9c', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E003', 'E003', 'Priya', 'Raman', 'priya.raman@northwind.example', '+1-212-555-0003', 'active', 'full_time', '2025-01-06', 'ENG-BE', 'Software Engineer', 'L3', 'IN-BLR', '6d466aa9-e51a-5d52-9015-152600855932', 'Asia/Kolkata', 'INR', 2100000, 'salary', 'monthly', TRUE, 85, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E003"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('b9b84064-a67a-5048-8282-8fc048b4dbfb', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E004', 'E004', 'Tom', 'Whitfield', 'tom.whitfield@northwind.example', '+1-212-555-0004', 'active', 'full_time', '2025-01-26', 'ENG-FE', 'Software Engineer', 'L4', 'US-NYC', '6d466aa9-e51a-5d52-9015-152600855932', 'America/New_York', 'USD', 148000, 'salary', 'monthly', FALSE, 195, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E004"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('11f31511-ad53-59c7-9e90-8ee3b553489b', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E005', 'E005', 'Aisha', 'Okafor', 'aisha.okafor@northwind.example', '+1-212-555-0005', 'active', 'full_time', '2025-02-15', 'CONSULT', 'Senior Consultant', 'C2', 'US-NYC', NULL, 'America/New_York', 'USD', 142000, 'salary', 'monthly', FALSE, 265, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E005"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('c095eafa-952e-5047-961a-82ce7b45cbf1', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E006', 'E006', 'James', 'Reid', 'james.reid@northwind.example', '+1-212-555-0006', 'active', 'full_time', '2025-03-07', 'CONSULT', 'Senior Consultant', 'C2', 'UK-LON', '11f31511-ad53-59c7-9e90-8ee3b553489b', 'Europe/London', 'GBP', 88000, 'salary', 'monthly', FALSE, 240, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E006"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('18503470-ba5c-5450-bc3e-b0a2454d757f', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E007', 'E007', 'Lena', 'Fischer', 'lena.fischer@northwind.example', '+1-212-555-0007', 'active', 'full_time', '2025-03-27', 'CONSULT', 'Senior Consultant', 'C2', 'UK-LON', '11f31511-ad53-59c7-9e90-8ee3b553489b', 'Europe/London', 'GBP', 82000, 'salary', 'monthly', FALSE, 235, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E007"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('e05fd53c-ebdf-5049-810a-28a63369f93a', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E008', 'E008', 'Diego', 'Morales', 'diego.morales@northwind.example', '+1-212-555-0008', 'active', 'full_time', '2025-04-16', 'SALES', 'Account Executive', 'C2', 'UK-LON', NULL, 'Europe/London', 'GBP', 71000, 'salary', 'monthly', FALSE, NULL, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E008"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('fa4c9324-158b-55b7-acdd-7fe7917bc7cf', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E009', 'E009', 'Yuki', 'Tanaka', 'yuki.tanaka@northwind.example', '+1-212-555-0009', 'active', 'full_time', '2025-05-06', 'SALES', 'Account Executive', 'C2', 'US-NYC', 'e05fd53c-ebdf-5049-810a-28a63369f93a', 'America/New_York', 'USD', 118000, 'salary', 'monthly', FALSE, NULL, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E009"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('a87e0200-0849-53b6-a491-e882feace3f5', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E010', 'E010', 'Rachel', 'Adeyemi', 'rachel.adeyemi@northwind.example', '+1-212-555-0010', 'active', 'full_time', '2025-05-26', 'GA', 'Office Administrator', 'C2', 'US-NYC', NULL, 'America/New_York', 'USD', 68000, 'salary', 'monthly', TRUE, NULL, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E010"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('56bd1329-6740-572f-aa90-c44d1b27bedf', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E011', 'E011', 'Oliver', 'Grant', 'oliver.grant@northwind.example', '+1-212-555-0011', 'active', 'part_time', '2025-06-15', 'ENG-FE', 'Software Engineer', 'L3', 'US-NYC', '6d466aa9-e51a-5d52-9015-152600855932', 'America/New_York', 'USD', 104000, 'salary', 'monthly', FALSE, 165, 0.5, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E011"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85'),
    ('385f5ae5-e567-5fb6-98f8-b45007099ff8', '07fb03f8-1521-5ef4-9c2d-25fcfa297ac1', 'E012', 'E012', 'Nadia', 'Hassan', 'nadia.hassan@northwind.example', '+1-212-555-0012', 'active', 'contractor', '2025-07-05', 'CONSULT', 'Senior Consultant', 'C2', 'US-NYC', '11f31511-ad53-59c7-9e90-8ee3b553489b', 'America/New_York', 'USD', 96000, 'salary', 'monthly', FALSE, 210, 1.0, TRUE, '{"shirt_size": "M", "legacy_id": "HR-E012"}'::jsonb, '{"annual": {"balance": 12.5, "unit": "days"}}'::jsonb, '2026-01-01T09:00:00Z', '2026-01-01T09:00:00Z', '48ccc5de-9ba7-5461-ab49-160a1146ed85');
