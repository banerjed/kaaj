...
/**
 * Deactivate, never delete: employees reference a department by
 * `department_code`, and holidays and payroll policies hang off the structure.
 * A removed row would orphan them silently.
 */
