...
// (5,000) can't be tripped by the fixture's own open-AR/AP count, so this
// drives the refusal directly (L48). Only REPORT_ROW_CAP is overridden;
// `fxRevaluation()` itself is untouched.
...
import { GET as fxRevaluationExport } from "./+server"
